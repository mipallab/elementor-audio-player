...
* **Two Podcast Types**
  * Audio Player &mdash; upload or select an audio file via the WordPress media library
  * External Link &mdash; direct visitors to Spotify, Apple Podcasts, or any external platform
